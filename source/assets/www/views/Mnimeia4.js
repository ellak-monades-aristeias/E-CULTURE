KitchenSink.Mnimeia4 = function(params) {
	...
	*/
		...
		loginfunc: function () {
			...
			else
			{
				...
				{
					score = 0;
					DevExpress.ui.notify('Δώσατε λανθασμένη απάντηση. Η σωστή απάντηση ήταν το 1905', 'error', 2000);
				}
				
				cat1value = cat1value + score;
				KitchenSink.app.navigate("Mnimeia5");
