KitchenSink.History5 = function(params) {
...
/*	
	...
	*/
		...
		genders: [
			{ text: "Αλή Πασάς", value: "1" },
			{ text: "Μεχμέτ Πασάς", value: "2" },
			{ text: "Σινάν Πασάς", value: "3" },
			{ text: "Αληζότ Πασάς", value: "4" }
		],
		...
		loginfunc: function () {
			...
			else
			{
				...
				{
					score = 0;
					DevExpress.ui.notify('Δώσατε λανθασμένη απάντηση. Η σωστή απάντηση ήταν ο Σινάν Πασάς', 'error', 2000);
				}
				
				cat3value = cat3value + score;
				KitchenSink.app.navigate("History6");
