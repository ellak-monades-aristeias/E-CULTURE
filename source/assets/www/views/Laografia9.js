KitchenSink.Laografia9 = function(params) {
...
/*	
	...
	*/
		...
		genders: [
			{ text: "η βάρβιτος", value: "1" },
			{ text: "η πανδουρίς", value: "2" },
			{ text: "ο αυλός", value: "3" },
			{ text: "ο ταμπουράς", value: "4" }
		],
		...
		loginfunc: function () {
			...
			else
			{
				...
				{
					score = 0;
					DevExpress.ui.notify('Δώσατε λανθασμένη απάντηση. Η σωστή απάντηση ήταν ο ταμπουράς', 'error', 2000);
				}
