KitchenSink.Arxaia6 = function(params) {
...
/*	
	...
	*/
		...
		genders: [
			{ text: "Η Νίκη", value: "1" },
			{ text: "Η ομορφιά της γυναίκας ", value: "2" },
			{ text: "Η Περσεφόνη", value: "3" },
			{ text: "Η εξουσία του Πύρρου", value: "4" }
		],
		...
		loginfunc: function () {
			...
			else
			{
				...
				{
					score = 0;
					DevExpress.ui.notify('Δώσατε λανθασμένη απάντηση. Η σωστή απάντηση ήταν Η Νίκη', 'error', 2000);
				}
				
				cat2value = cat2value + score;
				KitchenSink.app.navigate("Arxaia7");
