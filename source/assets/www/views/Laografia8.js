KitchenSink.Laografia8 = function(params) {
...
/*	
	...
	*/
		...
		genders: [
			{ text: "Σεγκούνι", value: "1" },
			{ text: "Φλοκάτα", value: "2" },
			{ text: "Αντερί", value: "3" },
			{ text: "Πατούνες", value: "4" }
		],
		...
		loginfunc: function () {
			...
			else
			{
				...
				{
					score = 0;
					DevExpress.ui.notify('Δώσατε λανθασμένη απάντηση. Η σωστή απάντηση ήταν Σεγκούνι', 'error', 2000);
				}
				
				cat4value = cat4value + score;
				KitchenSink.app.navigate("Laografia9");
