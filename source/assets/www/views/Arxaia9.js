KitchenSink.Arxaia9 = function(params) {
...
/*	
	...
	*/
		...
		genders: [
			{ text: "Άρτα", value: "1" },
			{ text: "Πρέβεζα", value: "2" },
			{ text: "Ηγουμενίτσα", value: "3" },
			{ text: "Ιωάννινα", value: "4" }
		],
		...
		loginfunc: function () {
			...
			else
			{
				...
				{
					score = 0;
					DevExpress.ui.notify('Δώσατε λανθασμένη απάντηση. Η σωστή απάντηση ήταν στην Πρέβεζα', 'error', 2000);
				}
				
				cat2value = cat2value + score;
				KitchenSink.app.navigate("Arxaia10");
