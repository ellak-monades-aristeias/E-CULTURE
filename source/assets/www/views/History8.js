KitchenSink.History8 = function(params) {
...
/*	
	...
	*/
		...
		genders: [
			{ text: "τους Ενετούς", value: "1" },
			{ text: "τους Τούρκους", value: "2" },
			{ text: "τον Αλή Πασά", value: "3" },
			{ text: "τους Ρωμαίους", value: "4" }
		],
		...
		loginfunc: function () {
			...
			else
			{
				...
				{
					score = 0;
					DevExpress.ui.notify('Δώσατε λανθασμένη απάντηση. Η σωστή απάντηση ήταν τους Ενετούς', 'error', 2000);
				}
				
				cat3value = cat3value + score;
				KitchenSink.app.navigate("History9");
