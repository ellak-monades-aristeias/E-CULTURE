KitchenSink.Arxaia12 = function(params) {
...
/*	
	...
	*/
		...
		genders: [
			{ text: "Ετρούσκοι", value: "1" },
			{ text: "Χάονες", value: "2" },
			{ text: "Μολοσσοί", value: "3" },
			{ text: "Θεσπρωτοί Ηπειρώτες", value: "4" }
		],
		...
		loginfunc: function () {
			...
			else
			{
				...
				{
					score = 0;
					DevExpress.ui.notify('Δώσατε λανθασμένη απάντηση. Η σωστή απάντηση ήταν οι Θεσπρωτοί Ηπειρώτες', 'error', 2000);
				}
				
				cat2value = cat2value + score;
				KitchenSink.app.navigate("Arxaia13");
