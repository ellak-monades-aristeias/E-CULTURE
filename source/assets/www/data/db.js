...
console.log('db');
    ...
    var gallery = [
            { src: "url(file:///mnt/sdcard/Android/data/photo0.jpg)" },
            { src: "url(file:///mnt/sdcard/Android/data/photo1.jpg)" },
            { src: "url(file:///mnt/sdcard/Android/data/photo2.jpg)" },
            { src: "url(file:///mnt/sdcard/Android/data/photo3.jpg)" },
            { src: "url(file:///mnt/sdcard/Android/data/photo4.jpg)" },
            { src: "url(file:///mnt/sdcard/Android/data/photo5.jpg)" },
            { src: "url(file:///mnt/sdcard/Android/data/photo6.jpg)" },
            { src: "url(file:///mnt/sdcard/Android/data/photo7.jpg)" },
            { src: "url(file:///mnt/sdcard/Android/data/photo8.jpg)" },
            { src: "url(file:///mnt/sdcard/Android/data/photo9.jpg)" }			
    ];
	
    var gallery2 = [
            { src: "url(content/images/gallery/planogram.jpg)" },
            { src: "url(content/images/gallery/planogram2.jpg)" },
            { src: "url(content/images/gallery/planogram3.jpg)" },
            { src: "url(content/images/gallery/planogram4.jpg)" },
            { src: "url(content/images/gallery/planogram5.jpg)" }
    ];	
