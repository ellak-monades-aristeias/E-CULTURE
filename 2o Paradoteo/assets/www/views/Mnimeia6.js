KitchenSink.Mnimeia6 = function(params) {
...
/*	
	...
	*/
		...
		genders: [
			{ text: "Δρίσκος", value: "1" },
			{ text: "Σούλι", value: "2" },
			{ text: "Μουργκάνα", value: "3" },
			{ text: "Ζάλογγο", value: "4" }
		],
		...
		loginfunc: function () {
			...
			else
			{
				...
				{
					score = 0;
					DevExpress.ui.notify('Δώσατε λανθασμένη απάντηση. Η σωστή απάντηση ήταν το Σούλι', 'error', 2000);
				}
				
				cat1value = cat1value + score;
				KitchenSink.app.navigate("Mnimeia7");
