KitchenSink.History7 = function(params) {
...
/*	
	...
	*/
		...
		genders: [
			{ text: "το 19 αιώνα", value: "1" },
			{ text: "τον 5ο αιώνα", value: "2" },
			{ text: "το 2ο αιώνα", value: "3" },
			{ text: "τον 16ο αιώνα", value: "4" }
		],
		...
		loginfunc: function () {
			...
			else
			{
				...
				{
					score = 0;
					DevExpress.ui.notify('Δώσατε λανθασμένη απάντηση. Η σωστή απάντηση ήταν τον 16ο αιώνα', 'error', 2000);
				}
				
				cat3value = cat3value + score;
				KitchenSink.app.navigate("History8");
