KitchenSink.Arxaia4 = function(params) {
...
/*	
	...
	*/
		...
		genders: [
			{ text: "Δρυάδες", value: "1" },
			{ text: "Νηρηίδες", value: "2" },
			{ text: "Χάριτες", value: "3" },
			{ text: "Πελειάδες", value: "4" }
		],
		...
		loginfunc: function () {
			...
			else
			{
				...
				{
					score = 0;
					DevExpress.ui.notify('Δώσατε λανθασμένη απάντηση. Η σωστή απάντηση ήταν οι Πελειάδες', 'error', 2000);
				}
				
				cat2value = cat2value + score;
				KitchenSink.app.navigate("Arxaia5");
