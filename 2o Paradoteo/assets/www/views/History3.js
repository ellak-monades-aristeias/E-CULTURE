KitchenSink.History3 = function(params) {
...
/*	
	...
	*/
		...
		genders: [
			{ text: "3ος αιώνας μ.Χ.", value: "1" },
			{ text: "10ος αιώνας μ.Χ.", value: "2" },
			{ text: "1ος αιώνας μ.Χ.", value: "3" },
		...
		loginfunc: function () {
			...
			else
			{
				...
				KitchenSink.app.navigate("History4");
