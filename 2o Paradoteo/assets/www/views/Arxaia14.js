KitchenSink.Arxaia14 = function(params) {
...
/*	
	...
	*/
		...
		genders: [
			{ text: "Νικόπολη", value: "1" },
			{ text: "Κασσώπη", value: "2" },
			{ text: "Δωδώνη", value: "3" },
			{ text: "Αμβρακία", value: "4" }
		],
		...
		loginfunc: function () {
			...
			else
			{
				...
				{
					score = 0;
					DevExpress.ui.notify('Δώσατε λανθασμένη απάντηση. Η σωστή απάντηση ήταν η Αμβρακία', 'error', 2000);
				}
				
				cat2value = cat2value + score;
				KitchenSink.app.navigate("Arxaia15");
