KitchenSink.Mnimeia5 = function(params) {
...
/*	
	...
	*/
		...
		genders: [
			...
			{ text: "Κυριάκος Ρόκος", value: "2" },
			{ text: "Περικλή Μελίρρυτος", value: "3" },
			{ text: "Γιώργος Χουλιαράς", value: "4" }
		],
		...
		loginfunc: function () {
			...
			else
			{
				...
				{
					score = 0;
					DevExpress.ui.notify('Δώσατε λανθασμένη απάντηση. Η σωστή απάντηση ήταν ο Περικλή Μελίρρυτος', 'error', 2000);
				}
				
				cat1value = cat1value + score;
				KitchenSink.app.navigate("Mnimeia6");
